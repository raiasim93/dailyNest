    ...
    <>
        ...
        <div className="row g-0 w-100">
          <div className="col-10 mx-auto d-flex justify-content-between align-items-center">
            ...
            <div className="col-3 d-flex justify-content-start align-items-center">
              ...
              <Link
                to="/"
                className="fs-3 fw-normal text-decoration-none ms-2 text-white align-middle pointer"
              >
                DailyNest
              </Link>
            </div>
            ...
            <div className="col-6 d-flex justify-content-center align-items-center">
              ...
              {/* <div className="d-flex justify-content-center align-items-center w-100">
                <Link
                  to="/upcoming"
                  className="btn btn-custom-button border ms-2"
                >
                  <UpcomingIcon />
            ...
            <div className="col-3 d-flex justify-content-end align-items-center pe-0">
              <div className="d-flex justify-content-end align-items-center">
                <Link
                  to="/login"
                  className="btn btn-custom-button border ms-3 d-none d-md-block"
                >
                  <LoginIcon /> Log In
                </Link>
                <Link
      ...
      <div className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <div className="sidebar-links">
          {/* <Link
            to="/upcoming"
            className="text-decoration-none btn p-3 mb-2 border text-center text-white fw-normal fs-3 d-block w-100"
          >
            Upcoming
          </Link>
          <Link
          ...
          <Link
            to="/create-account"
            className="text-decoration-none btn p-3 mb-2 border text-center fw-normal text-white fs-3 d-block w-100"
          >
            Create Account
          </Link>
        </div>
